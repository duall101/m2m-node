...
void setup()
{
	...
	USB.println(F("Sensor Wram up, wait for 3minutes, Using deepsleep mode to reduce the battery consumption"));
...
void LoRa_Setup()
{
	...
	*/
	...
	// Set Node Address: from 2 to 255                                       //////Address Setting 
